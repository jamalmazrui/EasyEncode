...
If not $CmdLine[0] Then _ConsoleExit("Syntax:" & @CrLf & "utf16 FilePath")
...
ElseIf $sEncoding = "utf16" Then 
_ConsoleExit("Already utf16 encoding")
EndIf

$sBody = _FileRead($sFile)
FileDelete($sFile)
_FileWriteUtf16($sFile, $sBody)
