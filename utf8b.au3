...
If not $CmdLine[0] Then _ConsoleExit("Syntax:" & @CrLf & "utf8b FilePath")
...
ElseIf $sEncoding = "utf8b" Then
_ConsoleExit("Already utf8b encoding")
EndIf

$sBody = _FileRead($sFile)
FileDelete($sFile)
_FileWriteUtf8b($sFile, $sBody)
